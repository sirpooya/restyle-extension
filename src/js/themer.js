...
/* theme-modern.css is imported LAST in each page entry (popup/manage/options)
 * so its control restyles win over per-page CSS. Tokens here or there resolve
 * the same since pages only consume the vars, not redefine them. */
